"""
	...
	This code is meant to read and send data from the Arduino Mega 2560 which is connected to the Atlas Scientific Dissolved Oxygen
    sensor. This program should be able to send commands to the arduino to control the sensor as well as receive DO
